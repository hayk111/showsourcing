...
// const scriptMixPanel = document.createElement('script');
// scriptMixPanel.setAttribute('type', 'text/javascript');
// scriptMixPanel.innerHTML =
...
// document.head.appendChild(scriptMixPanel);
