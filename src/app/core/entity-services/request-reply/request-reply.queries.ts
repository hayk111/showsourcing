...
export abstract class RequestReplyQueries extends GlobalQueries {
	...
	static readonly fields = `fields { id, definition { id, label, type, target, originId }, value }`;
	static readonly images = `images { id, orientation, imageType, deleted, urls { id, url } }`;
