...
// import { Entity, EntityName } from '~core/erm/models';
...
// 	constructor(protected analyticsSrv?: AnalyticsService) {
// 	}
...
// 	 */
// 	queryOne(type: EntityName | string, id: string, fields?: string | string[]): Observable<T> {
// 		// title for displaying in logs
// 		const title = 'Query one ' + type;
