...
export const defaultConfig: TableConfig = {
	...
	creationDate: { name: 'creationDate', translationKey: 'created-on', width: 120, sortProperty: 'createdAt' },
	...
	product: { name: 'product', translationKey: 'product', width: 210, sortProperty: 'product' },
