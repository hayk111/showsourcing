...
export const selectNumTasksForSelection = createSelector([ selectTaskArrayForCurrentTarget ], ( tasks: Array<any>) => {
	return tasks.length;
});
...
export const selectNumCommentsForCurrentTarget = createSelector([ selectCommentsArrayForCurrentTarget ], ( comments: Array<any>) => {
