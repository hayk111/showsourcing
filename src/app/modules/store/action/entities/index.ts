...
// product
export const ProductActionTypes = makeBasicActionTypes(entityRepresentationMap.product);
addActionType(ProductActionTypes, entityRepresentationMap.product, 'REQUEST_PDF');
export const ProductActions: any = makeBasicActions(ProductActionTypes);
