...
@Component({
	selector: 'app-rating-library-page',
	templateUrl: './rating-library-page.component.html',
	styleUrls: ['./rating-library-page.component.scss'],
	changeDetection: ChangeDetectionStrategy.OnPush
})
export class RatingLibraryPageComponent implements OnInit {
