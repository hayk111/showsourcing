...
@Component({
	selector: 'input-checkbox-list-app',
	templateUrl: './input-checkbox-list.component.html',
	styleUrls: ['./input-checkbox-list.component.scss'],
	providers: [makeAccessorProvider(InputCheckboxListComponent)],
	changeDetection: ChangeDetectionStrategy.OnPush,
})
export class InputCheckboxListComponent extends AbstractInput
	implements OnInit {
