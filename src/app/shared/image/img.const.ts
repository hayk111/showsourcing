...
export class ImageUrls {
	static readonly s = 'https://files.showsourcing.com/s';
...
/** user */
export const DEFAULT_USER_IMG = 'assets/img/user.svg';

export const DEFAULT_USER_ICON = 'assets/icons/user.svg';

/** product */
export const DEFAULT_PRODUCT_IMG = 'assets/img/product.svg';
