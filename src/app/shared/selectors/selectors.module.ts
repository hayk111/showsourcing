...
import { SelectorElementSelectorComponent } from './components/selectors/selector-element-selector/selector-element-selector.component';
...
@NgModule({
	...
	declarations: [
		...
		SelectorElementSelectorComponent
	],
	exports: [
		SelectorComponent,
		SelectorPlaceholderComponent,
