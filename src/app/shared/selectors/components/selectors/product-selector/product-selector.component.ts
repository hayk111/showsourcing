...
@Component({
	selector: 'product-selector-app',
	templateUrl: './product-selector.component.html',
	styleUrls: ['./product-selector.component.scss'],
	changeDetection: ChangeDetectionStrategy.OnPush
})
export class ProductSelectorComponent extends AbstractSelectorComponent {
	...
	createFn(): any {
		...
		let item;
		let createObs$: Observable<Product>;
		if (name) {
			item = new Product({ name });
			createObs$ = this.productSrv.create(item);
		}
