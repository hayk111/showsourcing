...
xdescribe("ConstPipe", () => {
	...
	it('transform ("Laem Chabang", "harbours", "name") to "Laem Chabang"', () => {
		expect(pipe.transform("Laem Chabang", "harbours", "name")).toBe(
			"Laem Chabang"
		);
	});

	it('transform ("Tanger-Med (Tangiers)", "harbours", undefined) to "Tanger-Med (Tangiers)"', () => {
		expect(pipe.transform("Tanger-Med (Tangiers)", "harbours")).toBe(
			"Tanger-Med (Tangiers)"
		);
	});
	...
	it('transform ("_UnderAssessment", "statuses", "name") to "Under Assessment"', () => {
		expect(pipe.transform("_UnderAssessment", "statuses", "name")).toBe(
			"Under Assessment"
		);
	});
	...
	it('transform ("inProgress", "statusCategory", "name") to "In Progress"', () => {
		expect(pipe.transform("inProgress", "statusCategory", "name")).toBe(
			"In Progress"
		);
	});
	...
	it('transform ("refused", "statusCategories", "name") to "Refused"', () => {
		expect(pipe.transform("refused", "statusCategories", "name")).toBe(
			"Refused"
		);
	});

	it('transform ("inProgress", "statusCategories", undefined) to "In Progress"', () => {
		expect(pipe.transform("inProgress", "statusCategories")).toBe(
			"In Progress"
		);
	});
	...
	it('transform ("resent", "statusRequestSupplier", "name") to "Sent Back from buyer"', () => {
		expect(pipe.transform("resent", "statusRequestSupplier", "name")).toBe(
			"Sent Back from buyer"
		);
	});

	it('transform ("canceled", "statusRequestSupplier", undefined) to "Canceled"', () => {
		expect(pipe.transform("canceled", "statusRequestSupplier")).toBe(
			"Canceled"
		);
	});
	...
	it('transform ("pending", "statusRequestsSupplier", "name") to "To Reply"', () => {
		expect(pipe.transform("pending", "statusRequestsSupplier", "name")).toBe(
			"To Reply"
		);
	});
	...
	it('transform ("resent", "statusRequestTeam", "name") to "Sent Back to supplier"', () => {
		expect(pipe.transform("resent", "statusRequestTeam", "name")).toBe(
	...
	it('transform ("validated", "statusRequestsTeam", "name") to "Validated"', () => {
		expect(pipe.transform("validated", "statusRequestsTeam", "name")).toBe(
			"Validated"
		);
	});

	it('transform ("sent", "statusRequestsTeam", undefined) to "Sent to supplier"', () => {
		expect(pipe.transform("sent", "statusRequestsTeam")).toBe(
			"Sent to supplier"
		);
	});
	...
	it('transform ("_Manufacturer", "supplierType", "name") to "Manufacturer"', () => {
		expect(pipe.transform("_Manufacturer", "supplierType", "name")).toBe(
			"Manufacturer"
		);
	});
	...
	it('transform ("_Manufacturer", "supplierTypes", undefined) to "Manufacturer"', () => {
		expect(pipe.transform("_Manufacturer", "supplierTypes")).toBe(
			"Manufacturer"
		);
	});
	...
	it('transform ("Already have an account?", "messages", "name") to "Already have an account?"', () => {
		expect(pipe.transform("Already have an account?", "messages", "name")).toBe(
			"Already have an account?"
		);
	});

	it('transform ("Don\'t have an account ?", "messages", undefined) to "Don\'t have an account ?"', () => {
		expect(pipe.transform("Don't have an account ?", "messages")).toBe(
