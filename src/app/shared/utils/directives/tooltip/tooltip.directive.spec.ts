...
@Component({
	template: `
		<div style="text-align: center;">
			<div
				toolTip
				toolTipMessage="toolTip above-right"
			...
			<div
				toolTip
				toolTipMessage="toolTip above-left"
			...
			<div
				toolTip
				toolTipMessage="toolTip below-right"
			...
			<div
				toolTip
				toolTipMessage="toolTip below-left"
				toolTipPosition="below-left"
			>
				below-left
			</div>
			<div toolTip toolTipMessage="toolTip right" toolTipPosition="right">
				right
			</div>
			<div toolTip toolTipMessage="toolTip left" toolTipPosition="left">
				left
			</div>
		</div>
	`
...
xdescribe("TooltipDirective", () => {
	...
	it("should open Tooltip when mouseenter the element", fakeAsync(() => {
		...
		expect(
			document.querySelectorAll("div.tooltip-directive").length
		).toBeGreaterThan(0);
	}));
	...
	it("should open Tooltip (above-right) when mouseenter the element", fakeAsync(() => {
		...
		fixture.detectChanges();
		tick(1000); // jasmine.clock().tick(1000);
		expect(document.querySelectorAll("div.above-right").length).toBeGreaterThan(
			0
		);
	...
	it("should open Tooltip (above-left) when mouseenter the element", fakeAsync(() => {
		...
		fixture.detectChanges();
		tick(1000); // jasmine.clock().tick(1000);
		expect(document.querySelectorAll("div.above-left").length).toBeGreaterThan(
			0
		);
	...
	it("should open Tooltip (below-right) when mouseenter the element", fakeAsync(() => {
		...
		fixture.detectChanges();
		tick(1000); // jasmine.clock().tick(1000);
		expect(document.querySelectorAll("div.below-right").length).toBeGreaterThan(
			0
		);
	...
	it("should open Tooltip (below-left) when mouseenter the element", fakeAsync(() => {
		...
		fixture.detectChanges();
		tick(1000); // jasmine.clock().tick(1000);
		expect(document.querySelectorAll("div.below-left").length).toBeGreaterThan(
			0
		);
