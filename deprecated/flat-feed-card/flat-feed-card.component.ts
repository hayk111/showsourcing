...
@Component({
	selector: 'flat-feed-card-app',
	templateUrl: './flat-feed-card.component.html',
	styleUrls: ['./flat-feed-card.component.scss'],
	changeDetection: ChangeDetectionStrategy.OnPush
})
export class FlatFeedCardComponent extends AutoUnsub implements OnInit {
